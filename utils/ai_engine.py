...
def decompose_knowledge_note(*args, **kwargs):
    """Ủy quyền thực thi sang utils.notes_manager."""
    from utils.notes_manager import decompose_knowledge_note as _dkn
    return _dkn(*args, **kwargs)


def synthesize_cross_notes(*args, **kwargs):
    """Ủy quyền thực thi sang utils.notes_manager."""
    from utils.notes_manager import synthesize_cross_notes as _scn
    return _scn(*args, **kwargs)
